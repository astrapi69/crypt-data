...
public class CertificateInfo
{
	...
	public CertificateInfo(int version, BigInteger serialNumber, String issuer, String subject, Valitidy valitidy, PublicKey publicKey, String signatureAlgorithm, Map<String, String> x509v3Extensions) {
	...
	public boolean equals(final Object o) {
		...
		if (this$valitidy == null ? other$valitidy != null : !this$valitidy.equals(other$valitidy)) return false;
		...
		if (this$x509v3Extensions == null ? other$x509v3Extensions != null : !this$x509v3Extensions.equals(other$x509v3Extensions))
			return false;
		return true;
	}
	...
	public String toString() {
		return "CertificateInfo(version=" + this.getVersion() + ", serialNumber=" + this.getSerialNumber() + ", issuer=" + this.getIssuer() + ", subject=" + this.getSubject() + ", valitidy=" + this.getValitidy() + ", publicKey=" + this.getPublicKey() + ", signatureAlgorithm=" + this.getSignatureAlgorithm() + ", x509v3Extensions=" + this.getX509v3Extensions() + ")";
	}
	...
	public static abstract class CertificateInfoBuilder<C extends CertificateInfo, B extends CertificateInfo.CertificateInfoBuilder<C, B>> {
		...
		private static void $fillValuesFromInstanceIntoBuilder(CertificateInfo instance, CertificateInfo.CertificateInfoBuilder<?, ?> b) {
